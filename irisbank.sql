...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 12 avr. 2026 à 18:41
...
INSERT INTO `users` (`id`, `nom`, `prenom`, `email`, `telephone`, `adresse`, `date_naissance`, `password_hash`, `role`, `created_at`, `is_admin`) VALUES
(2, 'Rajo', 'Rajit', 'rajo@gmail.com', '0612345678', 'Paris', '2000-01-01', '$2b$10$fpPnJSHqslRjrL4I4wp.EOxVNY0MqBebf161ipuoLvELbvb/1PoMO', 'ADMIN', '2026-03-04 16:18:53', 1),
(26, 'DELON', 'Alexi', 'delon@gmail.com', '0678678756', '40 rue de la Paix', '2001-12-12', '$2b$10$rdgTukr9hIxiac/YsSpzW.VdUpvCQHaP3LNYejDH40.Nf2WM7XyaC', 'CLIENT', '2026-04-02 09:25:42', 0),
(25, 'Sad', 'JEya', 'sad@gmail.com', '0767766775', '40 rue de la Paix', '2026-04-02', '$2b$10$2w2L4hjsx9o3PDYR/pP/M.WgIJAQQRaZcgXVqzOB.4yZpOK0cL0/2', 'CLIENT', '2026-04-01 09:21:33', 0);
COMMIT;
